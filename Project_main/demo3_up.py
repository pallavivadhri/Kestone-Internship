...
agent_prompt_template = PromptTemplate(
    ...
    template=(
        ...
        "- Use Tavily AND Serp api for web search. Use the Webscrape tool to scrape the homepage (e.g., www.companyname.com), not internal links like press releases.\n"
...
agent_1 = initialize_agent(
    tools=[tavily_tool, news_tool, wikipedia_tool,serp_tool,scrape_tool],
    llm=llm,
